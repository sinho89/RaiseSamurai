...
public class DynamicActor : BaseActor
{
    ...
    public int Lucky { get; protected set; } = 1;
    public int Exp
    {
        get { return _exp; }
        set
    ...
    public void SkillSetInfo(Skills skill)
    {
        ...
        if (skill.specialType == Defines.SpecialTypes.Default)
            Managers.Actor.SetNormalSkill(skill);
        else
            Managers.Actor.SetSpecialSkill(skill);
    }
